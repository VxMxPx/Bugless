...
-- Make sure we have our version of users table.
DROP TABLE IF EXISTS users;

-- Users Table, Set By Session Plug
...
-- Sessions Table, Set By Session Plug
-- No changes.
...
-- Additional User's Informations
...
-- One bug can have more users assigned to.
...
INSERT (project_id, key, value) INTO settings VALUES (0, 'installed', NOW());
